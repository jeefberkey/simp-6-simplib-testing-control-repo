...
mod 'simp-simplib',
  :git => 'https://github.com/jeefberkey/pupmod-simp-simplib',
  :ref => 'SIMP-1679'
...
mod 'simp-at',
  :git => 'https://github.com/jeefberkey/pupmod-simp-at',
  :ref => 'SIMP-2225'
...
mod 'simp-useradd',
  :git => 'https://github.com/jeefberkey/pupmod-simp-useradd',
  :ref => 'SIMP-2227'

mod 'simp-tuned',
  :git => 'https://github.com/jeefberkey/pupmod-simp-tuned',
  :ref => 'SIMP-2228'
...
mod 'saz-timezone',
  :git => 'https://github.com/jeefberkey/puppet-timezone',
  :ref => 'SIMP-2231'

mod 'simp-cron',
  :git => 'https://github.com/jeefberkey/pupmod-simp-cron',
  :ref => 'SIMP-2232'

mod 'simp-resolv',
  :git => 'https://github.com/jeefberkey/pupmod-simp-resolv',
  :ref => 'SIMP-2234'

mod 'trlinkin-nsswitch',
  :git => 'https://github.com/jeefberkey/puppet-nsswitch',
  :ref => 'SIMP-2235'

mod 'puppetlabs-motd',
  :git => 'https://github.com/jeefberkey/puppetlabs-motd',
  :ref => 'SIMP-2237'
